                                ...
                                <div id="smartwizard">
                                    ...
                                    <div class="tab-content">
                                                ...
                                                <div class="row mb-5">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input type="date" class="form-control" name="dob"
                                                                    id="dob" placeholder="Enter Your Date of Birth" required>
                                                                    <div class="valid-feedback">
                                                                        Looks good!
                                                                      </div>
                                                                      <div class="invalid-feedback">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="nie"
                                                                    id="nie"
                                                                    placeholder="Enter Your Spenish Residence Card No." required>
                                                                    <div class="valid-feedback">
                                                                        Looks good!
                                                                      </div>
                                                                      <div class="invalid-feedback">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    placeholder="Enter Your Native Country" required>
                                                                    <div class="valid-feedback">
                                                                        Looks good!
                                                                      </div>
                                                                      <div class="invalid-feedback">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="native_id"
                                                                    id="native_id"
                                                                    placeholder="Enter Your ID Card No. (Native Country)" required>
                                                                    <div class="valid-feedback">
                                                                        Looks good!
                                                                      </div>
                                                                      <div class="invalid-feedback">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="phone"
                                                                    id="phone" placeholder="Enter Your Cell No." required>
                                                                    <div class="valid-feedback">
                                                                        Looks good!
                                                                      </div>
                                                                      <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <textarea class="form-control" name="area" id="area" placeholder="Enter Your  Area / Street / House No." required></textarea>
                                                                <div class="valid-feedback">
                                                                    Looks good!
                                                                  </div>
                                                                  <div class="invalid-feedback">
                                        ...
                                        <div id="step-2" class="tab-pane" role="tabpanel" aria-labelledby="step-2">
                                            <form id="form-2" action="" class="needs-validation" novalidate>
                                                <div class="row mb-5">
                                                    <div class="col-12">
                                                        <h4 class="mb-4">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    placeholder="Enter Your Realtion" required>
                                                                    <div class="valid-feedback">
                                                                        Looks good!
                                                                      </div>
                                                                      <div class="invalid-feedback">
                                        ...
                                        <div id="step-3" class="tab-pane" role="tabpanel" aria-labelledby="step-3">
                                            <form id="form-3" action="" class="needs-validation" novalidate>
                                                <div class="row mb-5">
                                                    <div class="col-12">
                                                        <h4 class="mb-4">
                                        ...
                                        <div id="step-4" class="tab-pane" role="tabpanel" aria-labelledby="step-4">
                                            <form id="form-4" action="" class="needs-validation" novalidate>
                                                <div class="row mb-5">
                                                    <div class="col-12">
                                                        <h4 class="mb-4">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" id="rep_name"
                                                                    name="rep_name"
                                                                    placeholder="Enter Representative Full Name" required>
                                                                    <div class="valid-feedback">
                                                                        Looks good!
                                                                      </div>
                                                                      <div class="invalid-feedback">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    placeholder="Enter Representative Passport No." required>
                                                                    <div class="valid-feedback">
                                                                        Looks good!
                                                                      </div>
                                                                      <div class="invalid-feedback">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" id="rep_phone"
                                                                    name="rep_phone"
                                                                    placeholder="Enter Representative Cell No." required>
                                                                    <div class="valid-feedback">
                                                                        Looks good!
                                                                      </div>
                                                                      <div class="invalid-feedback">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <textarea class="form-control" name="rep_address" id="rep_address"
                                                                    placeholder="Enter Representative Complete Address" required></textarea>
                                                                <div class="valid-feedback">
                                                                    Looks good!
                                                                  </div>
                                                                  <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-lg-8 col-md-8 col-sm-12">
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="rep_confirmed" name="rep_confirmed" required>
                                        ...
                                        <div id="step-5" class="tab-pane" role="tabpanel" aria-labelledby="step-5">
                                            <form id="form-5" action="" class="needs-validation" novalidate>
                                                <div class="row mb-5">
                                                    <div class="col-12">
                                                        <h4 class="mb-4">
                                                    ...
                                                    <div class="col-12 mb-4">
                                                        ...
                                                        <div class="custom-control custom-radio mb-3">
                                                            <input type="radio" id="no_amount_anual"
                                                                name="annually_fund_amount" class="custom-control-input" required>
                                        ...
                                        <div id="step-6" class="tab-pane" role="tabpanel" aria-labelledby="step-6">
                                            <form id="form-6" action="" class="needs-validation" novalidate>
                                                <div class="row mb-5">
                                                    <div class="col-12">
                                                        <h4 class="mb-4">
                                                            Sign Your Form
