                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                           <input type="text" class="form-control" id="passport_no" name="passport_no" placeholder="Enter Doner's Passport No." disabled>
                                        </div>
                                     </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                           <input type="text" class="form-control" id="bank_name" name="bank_name" required placeholder="Enter Donner's Bank Name">
                                        </div>
                                     </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                           <input type="text" class="form-control" id="bank_ac_no" name="bank_ac_no" required placeholder="Enter Donner's Bank Account No.">
                                        </div>
                                     </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
