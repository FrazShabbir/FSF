        ...
        <li @if (in_array(request()->route()->getName(),
            ...
            <ul id="donation" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle" style="">
                ...
                @can('Read Donations')
                    ...
                    <li class="{{ request()->route()->getName() == 'donation.index'? 'active': '' }}"><a
                            href="{{ route('donation.index') }}?status=APPROVED"><i
                                class="las la-money-check-all"></i>Approved Donations</a>
                    </li>
                    <li class="{{ request()->route()->getName() == 'donation.index'? 'active': '' }}"><a
                            href="{{ route('donation.index') }}?status=PENDING"><i
                                class="las la-money-check-all"></i>Pending Donations</a>
                    </li>
                    <li class="{{ request()->route()->getName() == 'donation.index'? 'active': '' }}"><a
                            href="{{ route('donation.index') }}?status=REJECTED"><i
                                class="las la-money-check-all"></i>Rejected Donations</a>
                    </li>
                @endcan
            </ul>
        </li>
