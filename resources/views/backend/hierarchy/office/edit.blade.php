...
@section('title', 'Update Office | FSF')
                ...
                <div class="col-sm-12">
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body px-4">
                            <form action="{{ route('office.update',$office->office_code) }}" method="POST">
                                @csrf
                                    ...
                                    <div class="col-md-6 col-sm-12 mb-3">
                                        ...
                                        <select name="city_id" id="" class="form-control" required>
                                            @foreach (getCities() as $key)
                                                <option value="{{ $key->id }}" {{$office->city_id ==$key->id?'selected':''}}>{{ $key->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6 col-sm-12 mb-3">
                                        ...
                                        <select name="officehead" id="" class="form-control" required>
                                            @foreach (officeUsers() as $user)
                                                <option value="{{ $user->id }}" {{$office->officehead ==$user->id?'selected':''}}>{{ $user->full_name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <button type="submit" class="btn btn-primary mr-3">Update Details</button>
