                ...
                <div class="iq-card-body px-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12 mb-3">
                            ...
                            <input type="text" class="form-control"  disabled value="{{$community->name}}">
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12 mb-3">
                            ...
                            <input type="text" class="form-control" disabled value="{{$community->country->name}}">
                        </div>
                     </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    <input type="text" class="form-control"  disabled value="{{getStatus($community->status)}}">
                                 </div>
                            </div>
                        </div>
                      </div>
                      <a href="{{route('community.edit',$community->id)}}" class="btn btn-primary mr-3">Edit Community</a>
                      <a href="{{route('community.index')}}" class="btn iq-bg-danger mr-3">Back</a>

                </div>
             </div>
          </div>

          @if ($community->hod==auth()->user()->id)
          <div class="col-sm-12">
              <div class="iq-card">
                  <div class="iq-card-header d-flex justify-content-between">
                      <div class="iq-header-title">
                  ...
                  @if(communityApplications($community->id)->count()>0)
                      ...
                      <div class="table-responsive">
                          ...
                          <table id="FSF-Table" class="table table-striped table-bordered mt-4" role="grid"
                              ...
                              <tbody>
                                  ...
                                  @foreach (communityApplications($community->id) as $application)
                                      <tr>
