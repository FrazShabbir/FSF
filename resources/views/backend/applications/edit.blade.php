                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="surname" name="surname"
                                                    placeholder="Enter Your Sur Name" required value="{{ $application->surname ??  old('surname') }}">
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="date" class="form-control" name="dob" id="dob"
                                                    ...
                                                    value="{{ date('Y-m-d',strtotime($application->dob)) ??   old('dob') }}" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="phone" name="phone"
                                                    placeholder="2345678" required value="{{ $application->phone ?? old('phone') }}">
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="email" name="email"
                                                    placeholder="johndoe@gmail.com" required value="{{$application->user->email ??  old('email') }}">
                                                    <div class="valid-feedback">
                                                        Looks good!
                                                    </div>
                                            </div>
