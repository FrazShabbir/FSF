...
@section('title', 'All Donation Category')
                    ...
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            <div class="iq-header-title">
                                <h4 class="card-title">Donation Categories</h4>
                            </div>
                            <div class="">
                                <a href="{{ route('category.create') }}" class="btn btn-primary"><i
                                        class="las la-plus"></i>Add New Category</a>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($categories as $cat)
                                            <tr>
                                                <td>{{ $i }}</td>
                                                <td>{{ $cat->name }}</td>
                                                <td><span class="euro"></span> {{ $cat->donation }}</td>



                                                <td>
                                                    <form action="{{ route('category.destroy', $cat->code) }}"
                                                        method="post">
                                                        <div class="flex align-items-center list-user-action">
                                                            <a class="iq-bg-primary" data-toggle="tooltip"
                                                                data-placement="top" title=""
                                                                data-original-title="Show"
                                                                href="{{ route('category.show', $cat->code) }}"><i
                                                                    class="lar la-eye"></i></a>

                                                            <a class="iq-bg-primary" data-toggle="tooltip"
                                                                data-placement="top" title=""
                                                                data-original-title="Edit"
                                                                href="{{ route('category.edit', $cat->code) }}"><i
