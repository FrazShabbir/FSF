            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">APPLICATION : <b>{{ $application->application_id }}</b> <span
                                class="badge badge-{{ $application->status }}">{{ $application->status }}</span> <small>
                                <span class="badge badge-info">Exp:
                                    {{ $application->renewal_date ?? 'Approval Pending' }}</span></small></h4>
                    </div>
                    <div class="card-body">
                        <div class="container">
                            ...
                            <div>
                                <div class="row setup-content" id="step-1">
                                    <div class="col-xs-6 col-md-offset-3">
                                        <div class="col-md-12">
                                            ...
                                            @if ($application->staus=='Pending' or $application->staus=='RENEWABLE')
                              ...
                              <div class="alert alert-danger" role="alert">
                                <i class="fas fa-exclamation-triangle mr-2"></i>You did not have access to edit Representative's Information
                                            ...
                                            @if ($application->staus == 'Pending' or $application->staus == 'RENEWABLE')
                                                <a class="btn btn-danger rounded-pill btnEdit  mb-5 pull-right ml-3"
                                                    href="{{ route('enrollment.edit', $application->application_id) }}">EDIT</a>
                                            @endif <button
                                                class="btn btn-primary rounded-pill nextBtn mb-5 pull-right"
                                                type="button">Next</button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-xs-6 col-md-offset-3">
                                        <div class="col-md-12">
                                            <div class="">
                                                ...
                                                <p class="lead">
                                                    <img width="300px" src="{{ $application->user_signature }}"
                                                        alt="sign">
                                                </p>
                                            </div>
                                            <div class="row mb-5">
                            ...
                            @foreach ($application->comments as $status)
                                <div class="row pb-3">
                                    <div class="col-12"><span
                                            class="badge badge-{{ $status->status }}">{{ $status->status }}</span></div>
