                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" required class="form-control" name="full_name"
                                                            value="{{ getuser()->full_name ?? old('names') }}"
                                            ...
                                            <div class="row mb-5">
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea required value="{{ old('area') }}" class="form-control border rounded-pill" name="area"
                                                            id="area" placeholder="Address"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" required
                                                            value="{{ old('native_country') }}" class="form-control"
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label class="control-label">Complete Address (Native
                                                            Country)</label>
                                                        <textarea value="{{ old('native_country_address') }}" required class="form-control border rounded-pill"
                                                            name="native_country_address" id="native_country_address" placeholder="Native Address"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label class="control-label">Full Name</label>
                                                        <input type="text" required class="form-control"
                                                            value="{{ old('rep_name') }}" name="rep_name" id="rep_name"
                                                            placeholder="Muhammad Ahmad">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label class="control-label">Sur Name</label>
                                                        <input type="text" required class="form-control"
                                                            value="{{ old('rep_surname') }}" name="rep_surname"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label class="control-label">Passport No.</label>
                                                        <input type="text" required class="form-control"
                                                            value="{{ old('rep_passport_no') }}" name="rep_passport_no"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label class="control-label">Complete Address</label>
                                                        <textarea type="mail" required class="form-control border rounded-pill" value="{{ old('rep_address') }}"
                                                            name="rep_address" id="rep_address" placeholder="Address"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
