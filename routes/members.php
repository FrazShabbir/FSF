...
Route::group(['middleware' => ['auth'], 'prefix' => 'member'],function () {
    ...
    Route::get('donations', [MemberDonationController::class, 'index'])->name('donation.index');//->middleware(['can:Read enrollments']);
    Route::get('donation/start', [MemberDonationController::class, 'create'])->name('donation.create');//->middleware(['can:Create enrollments']);
    Route::post('donation/create/save', [MemberDonationController::class, 'store'])->name('donation.store');//->middleware(['can:Create enrollments']);
    Route::get('donation/{id}', [MemberDonationController::class, 'show'])->name('donation.show');//->middleware(['can:Read enrollments']);
    Route::get('donation/{id}/edit', [MemberDonationController::class, 'edit'])->name('donation.edit');//->middleware(['can:Update enrollments']);
    Route::put('donation/{id}/update', [MemberDonationController::class, 'update'])->name('donation.update');//->middleware(['can:Update enrollments']);
